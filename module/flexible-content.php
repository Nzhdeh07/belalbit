...
<?php if (have_rows('flexible-content')) : ?>
    ...
    <?php elseif (get_row_layout() == 'header') : ?>
        ...
        <div class="px-5 mobileLandscape:px-2.5">
            <div class="relative flex flex-col  items-center justify-center gap-2.5 py-10 rounded-md bg-cover bg-center"
                ...
                <div class="absolute z-10 inset-0 bg-[hsla(0,0%,85%,0.8)] pointer-events-none"></div>
                <h1 class="z-50 font-medium text-[36px] leading-[54px] text-black"><?php echo get_the_title(); ?></h1>

                <!-- Хлебные крошки (Yoast SEO) -->
                <?php if (function_exists('yoast_breadcrumb')): ?>
                    <div class="z-50 font-normal text-[14px] leading-5 text-breadcrumb">
                        <?php yoast_breadcrumb('<p  class="breadcrumbs-text underscore">', '</p>'); ?>
                    </div>
                <?php endif; ?>
    ...
    <?php elseif (get_row_layout() == 'office-map') : ?>
        <div class="relative flex items-center py-[57px] px-5 ">
            <iframe class="absolute inset-0 w-full h-full -z-10"
                    src="https://yandex.ru/map-widget/v1/?um=constructor%3Aabe5b96260b80551203e50a4c46db5f18d12bc577cf7fdbbdf6171b9afe20182&amp;source=constructor"
                    width="500"
                    height="400"
                    frameborder="0">
            </iframe>
            ...
            <div class="z-50 flex flex-col gap-2.5 p-5 rounded-md bg-white max-w-[455px]">
                <h3 class="font-medium text-[32px] leading-[48px] text-black"> Наш офис</h3>
                ...
                <p class="font-normal text-[14px] leading-5 text-customGray"><?php echo get_field('of-address', 'options') ?></p>
    ...
    <?php elseif (get_row_layout() == 'warehouse-map') : ?>
        <div class="relative flex items-center py-[57px] px-5 ">
            ...
            <div class="z-50 flex flex-col gap-2.5 p-5 rounded-md bg-white max-w-[455px]">
                <h3 class="font-medium text-[32px] leading-[48px] text-black">Склад</h3>
                ...
                <p class="font-normal text-[14px] leading-5 text-customGray">
                ...
                foreach ($documents as $document) :
                    ...
                    <div class="flex mobilePortrait:flex-col mobilePortrait:items-center gap-5">
                        <?php if (!empty($document_image)): ?>
                            <img class="max-h-[330px] max-w-[260px] h-full object-cover"
                        ...
                        <div class="flex flex-col gap-2.5 mobilePortrait:items-center">
                            <h3 class="font-medium text-[32px] leading-[48px] text-black mobilePortrait:text-center"><?php echo esc_html($document_title); ?></h3>
