<div style="display: none;" id="contact-modal" class="flex flex-col gap-5 p-5 rounded-md">
    <div class="modal-content">
        ...
        <form class="flex flex-col gap-5">
            ...
            <input type="hidden" value="Связаться" name="form_subject"/>
            ...
            <div class="flex flex-col gap-1.5">
                ...
                <input type="text" id="number" placeholder="+375 (__) ___-__-__" pattern="^\+375\d{9}$"
                       ...
                       required/>
                <input type="hidden" value="Заказать товар" name="form_subject"/>
            </div>
            <div class="flex flex-col gap-1.5">
                <label for="message"
                ...
                ></textarea>
                <button id="button-buy"  type="submit"
                        class="py-2 px-4 bg-customGreen-normal rounded-md font-medium text-[16px] leading-6 text-white">
                    Отправить
                </button>
                <p class="successMessage hidden" style=" color: green; text-align: center;">Спасибо! Ваша заявка отправлена.</p>
            </div>
            ...
            <div class="flex justify-center items-center gap-2.5">
                <a href="https://www.instagram.com/belalbit_ks/" target="_blank" rel="noopener noreferrer">
                    <img src="<?php echo get_stylesheet_directory_uri() . '/img/svg/instagram.svg'; ?>" alt="Instagram">
                </a>
                <a href="viber://chat?number=80447089375" target="_blank" rel="noopener noreferrer">
                    <img src="<?php echo get_stylesheet_directory_uri() . '/img/svg/viber.svg'; ?>" alt="Instagram">
                </a>
                <a href="https://wa.me/80447089375" target="_blank" rel="noopener noreferrer">
                    <img src="<?php echo get_stylesheet_directory_uri() . '/img/svg/whatsapp.svg'; ?>" alt="Instagram">
                </a>
                <a href="https://t.me/+375447089375" target="_blank" rel="noopener noreferrer">
                    <img src="<?php echo get_stylesheet_directory_uri() . '/img/svg/telegram.svg'; ?>" alt="Instagram">
                </a>
            </div>
        </form>
    </div>
...
<div style="display: none;" id="price" class="flex flex-col gap-5 p-5 rounded-md">
    <div class="modal-content">
        ...
        <form class="flex flex-col gap-5">
            ...
            <input type="hidden" id="productUrl" name="Ссылка на товар"/>
            <input type="hidden" id="productTitle" name="Название товара"/>
            <input type="hidden" value="Узнать цену" name="form_subject"/>
            ...
            <div class="flex flex-col gap-1.5">
                <button  type="submit"
                         class="button-buy py-2 px-4 bg-customGreen-normal rounded-md font-medium text-[16px] leading-6 text-white">
                    Отправить
                </button>
                <p class="successMessage hidden" style=" color: green; text-align: center;">Спасибо! Ваша заявка отправлена.</p>
            </div>
...
<div style="display: none;" id="buy" class="flex flex-col gap-5 p-5 rounded-md">
    <div class="modal-content">
        ...
        <form class="flex flex-col gap-5">
            ...
            <input type="hidden" id="productUrl" name="Ссылка на товар"/>
            <input type="hidden" id="productTitle" name="Название товара"/>
            <input type="hidden" id="productPrice" name="Цена товара"/>
            <input type="hidden" value="Заказать товар" name="form_subject"/>
            ...
            <div class="flex flex-col gap-1.5">
                <label for="message"
                       class="block font-medium text-[12px] leading-3 text-customGray-black">Комментарий</label>
                <textarea id="message" name="Комментарий" class="w-full px-3 py-2 border border-solid border-customBlue rounded-md"
                ></textarea>
                <button  type="submit"
                         class="button-buy py-2 px-4 bg-customGreen-normal rounded-md font-medium text-[16px] leading-6 text-white">
                    Отправить
