<footer id="footer" role="contentinfo">
    <div class="flex flex-col gap-10 px-[15px] py-10 bg-footerbg">
        <div class="flex desktop:grid grid-cols-2 justify-between gap-5">
            <!-- Первый блок  -->
            ...
            <!-- Второй блок - Почта  -->
            <div class="flex flex-col items-center desktop:items-start gap-5 ">

                <div class="text-center ">
                    <p class="text-customGreen font-bold text-[16px] leading-6">Почта для заявок</p>
                </div>
            ...
            <div class="flex flex-col gap-2.5">
                <div class="flex justify-between items-center">
                    <p class="uppercase font-bold text-[16px] leading-6 text-customGreen ">Адрес офиса</p>
                    <div class="flex  gap-1 items-center ">
                        <?php $link_url = get_field('of-link', 'options'); ?>
                ...
                <div class="flex justify-between items-center">
                    <p class="uppercase font-bold text-[16px] leading-6 text-customGreen ">Адрес склада</p>
                    <div class="flex gap-1 items-center ">
