...
<div class="grid grid-cols-[317px_1fr] tabletLandscape:grid-cols-1 min-h-full">
    ...
    <div class="flex flex-col gap-2.5">
        ...
        <div id="header-mobile" class="hidden mobileLandscape:flex sticky top-0 z-50">
            ...
            <div class="grid gap-10 my-2 mb-8  ">
                <div class="grid gap-10 my-2 ">
                    ...
                    <div class="flex-grow pt-10">
                        <div class="flex flex-col px-5 mobileLandscape:p-2.5 gap-2.5">
                            <div class="flex flex-col gap-2.5">
                                ...
                                <?php endif; ?>
                                <p class="font-medium text-[32px] leading-[48px] text-black">Блог</p>
                                    ...
                                    if ($total_pages > 1) {
                                        ...
                                        <div class="pagination-container ">
                                            <form action="" method="get"
                                                  class="pagination-form flex items-center gap-2.5">
                                                <label class="font-normal text-[16px] leading-5"
                                                       for="page_number"><?php _e('Перейти на страницу:', 'textdomain'); ?></label>
                                                <input class="custom-number-input" type="number" id="page_number"
                                                       name="paged"
