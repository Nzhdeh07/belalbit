<footer id="footer" role="contentinfo">
    <div class="flex flex-col gap-10 px-[15px] py-10 bg-footerbg">
        <div class="flex justify-between gap-5">

            <!-- Первый блок  -->
            <div class="flex flex-col gap-2.5 ">
                <div class="text-customGreen font-bold text-[16px] leading-6">
                ...
                <div class="flex flex-col gap-2.5 font-semibold text-white text-[16px] leading-5">
                    ...
                    <div class="flex flex-col gap-0.5 font-semibold text-[14px] leading-[21px]  ">
            ...
            <div class="flex items-center">
                <div class="border-2 border-solid border-customGreen-normal h-2/3"></div>
            </div>

            <!-- Второй блок - Почта  -->
            <div class="flex flex-col desktop:hidden items-center gap-5 ">
                <div class="text-center text-customGreen font-bold text-[16px] leading-6">
            ...
            <div class="flex flex-col wideDesktop:hidden  gap-[5px]">
                <div class="font-bold text-[16px] leading-6 text-customGreen">
                    <p>Каталог</p>
                </div>
                <div class="flex flex-col gap-2.5 font-semibold text-white text-[16px] leading-5">
                    <?php
            ...
            <!-- Вертикальный разделитель -->
            <div class="flex wideDesktop:hidden  items-center">
                <div class="border-2 border-solid border-customGreen-normal h-2/3"></div>
            </div>

            <!-- Четвертый блок - Адресса  -->
            <div class="flex flex-col gap-2.5">
                <div class="flex justify-between items-center text-customGreen ">
                    <p class="uppercase font-bold text-[16px] leading-6">Адрес офиса</p>
                    <div class="flex  gap-1 items-center ">
                        <p class="font-medium text-[14px] leading-5">Схема проезда</p>
                        <svg width="18" height="18" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M7.48611 7.02539H7.49285" stroke="hsla(148, 25%, 80%, 1)" stroke-width="2" stroke-linecap="round"
                                  stroke-linejoin="round"/>
                        </svg>
                    </div>
                </div>
                <div class="block font-medium text-[14px] leading-5 text-white">
                    <p><?php echo get_field('of-address', 'options') ?></p>
                </div>
                <div class="flex justify-between items-center text-customGreen ">
                    <p class="uppercase font-bold text-[16px] leading-6">Адрес склада</p>
                    <div class="flex gap-1 items-center ">
                        <p class="font-medium text-[14px] leading-5">Схема проезда</p>
                        <svg width="18" height="18" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M17.166 11.7501C17.166 13.6251 16.791 14.9376 15.951 15.7851L11.166 11.0001L16.9635 5.20264C17.0985 5.79514 17.166 6.47013 17.166 7.25013V11.7501Z"
